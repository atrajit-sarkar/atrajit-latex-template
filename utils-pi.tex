...
\providecommand{\fancyFootPageNumPi}{
...
\providecommand{\fancyHeaderContentPi}{
    ...
    % Left header: Author name with elegant styling
    \fancyhead[L]{%
        \footnotesize\scshape\color{piDark}%
        Atrajit Sarkar%
    }
